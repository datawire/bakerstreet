...
Usage:
  ...
  bakerscale sherlock DIRHOST STATSHOST
...
def main(args):
    ...
    if args["directory"]:
        os.execvp("directory", "directory -c /bakerst.conf".split())
    elif args["sherlock"]:
        os.execvp("sherlock", "sherlock -c /bakerst.conf --stats={0}".format(args['STATSHOST']).split())
    else:
